...
//               <Col xs={16} sm={8} md={6} lg={6} xl={6} xxl={6}>
//                 <Form.Item
...
//               </Col>
//               {/* select income ------------------------------------ */}
//               <Col xs={16} sm={8} md={6} lg={6} xl={6} xxl={6} className="">
//                 <Form.Item
...
//                         {item.title}
//                       </Title>
//                       <div className="recruitment__job-item company-name ps-4">{item.company}</div>
...
//                     <span className="ps-6">{item.updateTime}</span>
//                   </div>
//                 </div>
//               </Card>
//             ))}
